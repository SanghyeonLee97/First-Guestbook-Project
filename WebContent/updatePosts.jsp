...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    System.out.println(post.getWriting());
    %>
...
<body>
	...
	<form action="controller?cmd=updatePostAction&postCode=<%= post.getPostCode() %>" method="post">
    <select class="select-field" name="postTitle">
        <option value="자유게시판" style="font-size: 16px">자유게시판</option>
    </select> <br/>
    <input type="text" placeholder="제목 입력" class="input-field" name="title" value="<%= post.getTitle() %>"><br/><br/>
    <textarea placeholder="내용 입력"  class="textarea-field" name="writing"><%= post.getWriting() %></textarea>
    <br/>
    <button type="submit" class="button-up">수정</button>
</form>
